...
var maxWidth = canvas.width/8;
var lineHeight = canvas.width/70;
var x = (canvas.width - maxWidth + canvas.width/10) / 2;
var y = canvas.height/5.5;
var ctx = canvas.getContext('2d');
ctx.font = canvas.width/75+'pt wltr';
...
function firstText(){
var initialText  = "Buna! Da click pe mine pentru niste incredere!";
